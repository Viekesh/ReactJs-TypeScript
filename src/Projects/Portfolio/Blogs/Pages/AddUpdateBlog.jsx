...
const AddUpdateBlog = () => {
    ...
    // destructure the initial values (formData information) which we have defined in the above "useState" hook otherwise we will get error
    ...
    // This is for uploading the file, the useEffect only run when we have the file "ref" coming from firebase storage, "storage" coming from firebaseConfig file.
    ...
    return (
        <>
            <TopNav />
            <PageHeading heading="Add Or Update Blog" />
            <BottomNav />
            <section className="create_blog">
                <form className="user_blog_info" onSubmit={handleSubmit}>
                    ...
                    <div className="for_tag form_control">
                        <ReactTagInput
                            id="tag"
                            placeholder='Tags'
                            tags={tags}

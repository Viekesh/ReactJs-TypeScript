...
const CryptoContextProvider = ({ children }) => {
    ...
    return (
        <CryptoContext.Provider value={{ cryptoData, searchData, getSearchRes, setCoinSearch, setSearchData, currency, setCurrency }}>
            {children}
